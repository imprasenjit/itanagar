            ...
            <div class="flip-box">
              <div class="flip-box-inner">
                <div class="flip-box-front">
                  <img class="card-img-top" src="<?php echo base_url('assets/imglogo') . "/" . $l->logo; ?>" style="height:200px">
                </div>
                <div class="flip-box-back">
                  <img class="card-img-top" src="<?php echo base_url('assets/imglogo') . "/" . $l->logo2; ?>" style="height:200px">
