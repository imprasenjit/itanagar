...
<head>
  ...
  <!-- Ionicons 2.0.0 -->
  <link href="<?php echo base_url(); ?>public/admin/bower_components/Ionicons/css/ionicons.min.css" rel="stylesheet" type="text/css" />
  <!-- Theme style -->
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url(); ?>public/admin/dist/img/avatar.png" class="user-image" alt="User Image" />
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <img src="<?php echo base_url(); ?>public/admin/dist/img/avatar.png" class="img-circle" alt="User Image" />
                  <p>
                    <?php echo $name; ?>
