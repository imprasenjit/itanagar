...
<link rel="stylesheet" href="<?php echo base_url('public'); ?>/css/flipimage.css">
                  ...
                  <div class="flip-box">
                    <div class="flip-box-inner">
                      <div class="flip-box-front">
                        <img class="card-img-top" src="<?php echo base_url('assets/imglogo') . "/" . $range->logo; ?>" style="height:200px">
                      </div>
                      <div class="flip-box-back">
                        <img class="card-img-top" src="<?php echo base_url('assets/imglogo') . "/" . $range->logo2; ?>" style="height:200px">

                      </div>
                    </div>
                  </div>
                  <!-- <img style="height:100%;" src="<?php echo base_url('assets/imglogo') . "/" . $range->logo; ?>">
                  <img style="height:100%;" src="<?php echo base_url('assets/imglogo') . "/" . $range->logo2; ?>"> -->
