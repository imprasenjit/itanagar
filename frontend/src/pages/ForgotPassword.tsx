        ...
        <div className="card p-6">
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-gray-900 font-semibold mb-2">Check your inbox</p>
              <p className="text-sm text-gray-500">We sent a password reset link to <strong className="text-gray-900">{email}</strong></p>
            </div>
          ) : (
