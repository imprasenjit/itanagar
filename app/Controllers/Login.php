...
class Login extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('frontend/header') . view('login') . view('frontend/footer');
    }
    ...
    public function forgotPassword()
    {
        ...
        return view('frontend/header') . view('forgotPassword') . view('frontend/footer');
    }
    ...
    public function resetPasswordConfirmUser(string $activation_id, string $email)
    {
        ...
        return view('frontend/header') . view('newPassword', $data) . view('frontend/footer');
    }
